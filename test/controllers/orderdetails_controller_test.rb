...
class OrderdetailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create orderdetail" do
    assert_difference('Orderdetail.count') do
      post orderdetails_url, params: { orderdetail: { order_id: @orderdetail.order_id, product_id: @orderdetail.product_id, quantity: @orderdetail.quantity } }
    end
  ...
  test "should update orderdetail" do
    patch orderdetail_url(@orderdetail), params: { orderdetail: { order_id: @orderdetail.order_id, product_id: @orderdetail.product_id, quantity: @orderdetail.quantity } }
